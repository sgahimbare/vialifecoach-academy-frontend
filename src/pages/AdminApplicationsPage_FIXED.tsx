            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {selectedApplication.documents.recommendationLetters?.map((doc: string, index: number) => (
                  ...
                  {selectedApplication.documents.certificates?.map((doc: string, index: number) => (
                    <div key={index} className="flex items-center gap-3 p-3 bg-slate-700/50 rounded-lg">
                      <FileCheck className="h-4 w-4 text-green-400" />
                      <span className="text-white">{doc}</span>
                      <button className="admin-button-secondary ml-auto">View</button>
                  ...
                  {selectedApplication.documents.essays?.map((doc: string, index: number) => (
                    <div key={index} className="flex items-center gap-3 p-3 bg-slate-700/50 rounded-lg">
                      <FileCheck className="h-4 w-4 text-green-400" />
                      <span className="text-white">{doc}</span>
                      <button className="admin-button-secondary ml-auto">View</button>
              ...
              <div className="flex gap-3 pt-4 border-t border-slate-700">
                ...
                {/* Delete action for non-admitted applications */}
