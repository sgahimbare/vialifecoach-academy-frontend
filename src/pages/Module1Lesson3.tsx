      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
          ...
          <div className="bg-gray-100 rounded-lg p-8 mb-6 text-center">
            ...
            <p className="text-gray-600">Cognitive Distortions Explained</p>
            <p className="text-sm text-gray-500">Placeholder for cognitive distortions explanation video with examples</p>
          </div>
        ...
        <div className="flex justify-between">
          ...
          <Link 
            to={`/courses/${courseId}/module1/lesson4`}
