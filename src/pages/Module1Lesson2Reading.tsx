      ...
      <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h4 className="font-semibold text-gray-900 mb-4">
                Understanding the Speed of Thought
              </h4>
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h5 className="font-semibold text-gray-900 mb-2">The Low Road (The Amygdala)</h5>
                ...
                <div className="border-t pt-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h5 className="font-semibold text-gray-900 mb-2">The High Road (Prefrontal Cortex)</h5>
                      <p className="text-gray-700 mb-2">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex items-center space-x-3">
            {!module1Progress.isLessonCompleted('lesson2') && (
              <button
                onClick={() => module1Progress.markLessonCompleted('lesson2')}
...
export default Module1Lesson2Reading;
