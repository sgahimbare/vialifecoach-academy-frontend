      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
          ...
          <div className="bg-teal-50 border-l-4 border-teal-500 p-4 mb-6">
            ...
            <p className="text-teal-800">
              Understanding how your body creates your thoughts
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-900 rounded-2xl shadow-lg p-8 mb-6">
          ...
          <h2 className="text-2xl font-bold text-white mb-4 text-center">
            Body Scan & Vagus Nerve Demonstration
          </h2>
          <p className="text-gray-300 text-center mb-4">
            Placeholder for body scan demonstration and vagus nerve explanation video
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-teal-50 rounded-lg p-4">
              ...
              <p className="text-sm text-teal-800">
                Vagus nerve: 80% body → brain signals
              </p>
            </div>
            ...
            <div className="bg-yellow-50 rounded-lg p-4">
              ...
              <p className="text-sm text-yellow-800">
                Body tension → Brain invents thought
              </p>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-4">
              ...
              <p className="text-sm text-green-800">
                Body scan → Release tension → Mind follows
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between">
          ...
          <Link 
            to={`/courses/${id}/module1/lesson4/reading`}
...
export default Module1Lesson4Video;
